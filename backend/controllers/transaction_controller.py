...
@router.post("/api/transactions", response_model=transaction_schema.TransactionSchema)
...
@router.get("/api/transactions", response_model=List[transaction_schema.TransactionSchema])
...
async def get_transaction(
    ...
    return await transaction_service.get_transaction(transaction_id, user, db)
